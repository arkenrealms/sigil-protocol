...
- Validates `orderBy` parsing supports Prisma-style array envelopes, normalizes uppercase + whitespace-padded direction aliases (`ASC`/`DESC`, `" DESC "`), and rejects unsupported direction values.
