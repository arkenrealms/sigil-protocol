...
- Validates `orderBy` parsing supports Prisma-style array envelopes, normalizes uppercase/whitespace-padded directions, rejects unsupported direction values, and rejects empty sort objects.
