...
- Validates `orderBy` parsing supports Prisma-style array envelopes, normalizes uppercase direction aliases (`ASC`/`DESC`), and rejects unsupported direction values.
