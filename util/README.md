...
- `orderBy` direction values are whitespace-trimmed and case-normalized (`ASC`/`DESC`, including padded values like `" DESC "`, are accepted and normalized to lowercase).
